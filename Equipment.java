...
public class Equipment extends JFrame implements ActionListener {
    public static boolean[]equipmentAvailable = GlobalData.equipment;
    public Equipment(String name){
        ...
        //adding checkboxes
        JCheckBox noEquipBox = new JCheckBox("None", equipmentAvailable[0]);
        ...
        JCheckBox dumbellBox = new JCheckBox("Dumbells", equipmentAvailable[1]);
        ...
        JCheckBox barbellBox = new JCheckBox("Barbell", equipmentAvailable[2]);
        ...
        JCheckBox benchBox = new JCheckBox("Bench", equipmentAvailable[3]);
        benchBox.addActionListener(this);
        benchBox.setFont(MainApp.menuFont);
        benchBox.setSize(110, 25);
        benchBox.setLocation(20, 80);

        JCheckBox cableBox = new JCheckBox("Cables", equipmentAvailable[4]);
